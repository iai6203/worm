...
class App {
  ...
  private readonly span_of_explode_cnt: HTMLSpanElement;
  private readonly span_of_tiny_circle_cnt: HTMLSpanElement;
  ...
  constructor() {
    ...
    this.span_of_explode_cnt = document.querySelector('div.info span.explode-cnt') as HTMLSpanElement;
    this.span_of_tiny_circle_cnt = document.querySelector('div.info span.tiny-circle-cnt') as HTMLSpanElement;
